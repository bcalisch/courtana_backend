...
public class Violations {
	...
	public Violations(int id, int citation_number, String violation_number,
			String violation_description, String warrant_status,
			String warrant_number, String status, String status_update,
			String fine_amount, String court_cost) {
		super();
		this.id = id;
	...
	public String toString() {
		return Objects.toStringHelper(this).add("id", id)
				...
				.add("warrant_number", warrant_number).add("status", status)
				.add("status_update", status_update)
				.add("fine_amount", fine_amount).add("court_cost", court_cost)
				.toString();
